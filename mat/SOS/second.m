...
dx1dt = -1.57*x1 - 0.574*x2 + 0.861*x7  + 1.10*x11 + 1.14*x12+ 1.51*x9 ;
- 0.583*x3 + 0.942*x4 + 1.35*x6  +x2*x9*x6;
dx2dt = -0.760*x2 - 1.06*x7  + 0.681*x11 ;
+1.54*x3 - 1.63*x4 - 0.819*x5 - 0.925*x6 + x7*x10*x11- 0.535*x10;
dx7dt =-0.845*x1- 1.67*x7 + 1.72*x9   - 0.600*x12 + x1*x7*x11- 1.25*x11;
+ 0.839*x10
dx9dt = -1.25*x1 + 1.04*x2  - 1.20*x9 - 3.15*x11 - 0.998*x12 ;
+ 0.990*x3 - 1.44*x4 - 1.44*x5 -1.29*x6- 1.16*x10 + x1*x6*x10;
dx11dt = + 2.00*x7  + 2.46*x9  - 0.833*x11 + 1.29*x12 ;
-2.29*x3 + 1.41*x4 + 1.43*x5 + 0.512*x6 - 0.801*x8- 0.659*x10+ x6^3
dx12dt = -0.850*x1 + 0.515*x7 + 1.20*x9 - 1.25*x11 + x1*x9*x11;
- 0.919*x3;
dX1dt=[dx1dt;dx2dt;dx7dt;dx9dt;dx11dt;dx12dt];

dx1dt = -1.57*x1 - 0.583*x3 + 0.942*x4 + 1.35*x6; 
- 0.574*x2+ 0.861*x7  + 1.51*x9 + 1.10*x11 + 1.14*x12 +x6*x2*x9;
